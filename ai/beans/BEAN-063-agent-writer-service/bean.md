# BEAN-063: Agent Writer Service (Persona + Stack Team Members)
...
- Depends on BEAN-062 (Wire Pipeline) being complete so the pipeline is accepting real service calls
