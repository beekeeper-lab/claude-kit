# BEAN-066: Skills & Commands Copier Enhancement
...
- [ ] Generated projects have populated `.claude/commands/` directory (already works after BEAN-062)
...
- Depends on BEAN-062 (Wire Pipeline) so that asset copier is actually called during generation
