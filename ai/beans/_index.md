...
| BEAN-213 | Add Category Field to PersonaInfo Model | App | High | Approved | (unassigned) |
...
| BEAN-216 | Rename Stack to Expertise in Codebase | App | High | Approved | (unassigned) |
